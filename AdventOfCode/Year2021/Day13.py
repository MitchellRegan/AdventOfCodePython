...
def solution1():
    ...
    # Looping through each character in the data set to see how many '#' marks there are
    print("Year 2021, Day 13 solution part 1:", len(dataCopy))
...
def solution2():
    ...
    # Looping through each character in the data set to see how many '#' marks there are
    print("Year 2021, Day 13 solution part 2:")
